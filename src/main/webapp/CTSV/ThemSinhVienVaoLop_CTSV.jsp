        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					<div class = "row">
						<div class = "col-md-4">
						    <table id="gridview-lop" class="table table-bordered">
						      <thead>
						        <tr>
						          <th>Lớp học</th>
						          <th>Mã lớp</th>
						...
						<div class = "md-col-4">
						    <table id="gridview-thongtin" class="table table-bordered">
						      <thead>
						        <tr>
						          <th>MSSV</th>
						          <th>Họ tên</th>
						...
						<div class = "md-col-4">
						        ...
						        <select id="lophoc" class="form-control">
						          <option value="Toán 2">Toán 2</option>
						          <option value="Toán 1">Toán 1</option>
						        </select>
							    
						        <label for="mssv">MSSV</label>
						        <input type="text" id="mssv" class="form-control" placeholder="MSSV">
						    ...
						    <button type="button" id="btn-excel">Excel</button>
