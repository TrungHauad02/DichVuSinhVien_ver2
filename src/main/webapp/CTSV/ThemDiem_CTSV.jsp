            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<div class = "row">
						...
						<div class = "md-col-4">
						    <table id="gridview-diem" class="table table-bordered">
						      <thead>
						        <tr>
						          <th>MSSV</th>
						          <th>Loại điểm</th>
						...
						<div class = "md-col-4">
						        ...
						        <input type="number" id="diem" class="form-control" placeholder="Nhập điểm">
